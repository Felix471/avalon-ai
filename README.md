...
The per-round sabotage curve (`analysis/camouflage.md`) points the same way: on quest 1, full-prompt evil players sabotage 0/12 (GPT), 0/10 (Claude), and 1/22 (heterogeneous) of their opportunities, while naive-prompt evil players sabotage 10/12, 11/11, and 4/7. The "camouflage" behaviour is present exactly where the prompt asks for it.
